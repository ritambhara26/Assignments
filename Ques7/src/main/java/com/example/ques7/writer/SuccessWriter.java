...
public class SuccessWriter extends FlatFileItemWriter<Student> {
	public SuccessWriter() {
	this.setResource(new FileSystemResource("src/main/resources/output/selected.csv"));
